...
function tutupcari(){
    ...
    $('#cari').css({"transform":"translateY(-130px)"});
}
}
...
function bukacari(){
    ...
    $('#penutup').show();
    $('#cari input').focus();
    $('#cari').css({"transform":"translateY(56px)"});
}}
...
$(document).ready(function(){
  ...
  $('.navbar-nav li').hover(function() {
      ...
      aktif.addClass('navlist-active');
        $('#preview-konten').css({"top":'400px'});
    },function(){

        $('.navlist-active').removeClass('navlist-active');
             $('#preview-konten').css({"top":'0px'});
...
function index_donasi(a) {
  var r = ["plastik","sampah","lingkungan","apd","medis","corona","musholla","air","kebakaran", "asap", "guru", "gaza", "muhammad", "bencana", "banjir", "gempa", "tsunami", "zakat", "masjid", "pesantren", "palestina", "mualaf", "muslim", "islam", "dhuafa", "suriah", "syam", "pasien", "rumah sakit", "qur'an", "al-qur'an", "al qur'an", "quran","sumur"],
    e = 0;
